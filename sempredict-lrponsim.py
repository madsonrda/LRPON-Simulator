...
class ONU(object):
    def __init__(self,distance,oid,env,cable):
        ...
        self.last_req = 0
        self.excess = 0
        adist = functools.partial(random.expovariate, 500)
    ...
    def ONU_sender(self, cable):
        ...
        while True:
            ...
            if  self.port.byte_size > 0:
                ...
                #APartir daqui inicia o receiver da ONU
...
class OLT(object):
    ...
    def OLT_receiver(self,cable):
        ...
        while True:
            ...
            self.env.process(self.DBA_FIXO(msg['ONU'],cable))
